<template>
  <div class="nuxt-content">
    ...
    <div v-else>
        ...
        <div v-if="!error">
          ...
          <div>
            ...
            <div class="opciones-pestañas">
              <b-col
                class="pestaña"
                :class="this.pestañaActiva === 'Visita' ? 'active' : 'inactive'"
                @click="cambiarPestaña('Visita')"
                ><b-icon icon="clock"></b-icon> Visitas</b-col
              >
            </div>
            ...
            <div class="div-pestaña" v-if="this.pestañaActiva == 'Visita'">
              <b-row class="lista-historica">
                ...
                <div
                  v-for="(Linea, index) in visita.VisitasServicios.slice(
                    0,
                    limite
                  )"
                  :key="index"
                ...
                >
                  ...
                  <div class="mx-4 my-2 historicoTexto col">
                    <NuxtLink
                      :to="`/${$route.params.id.replace('/', '%2F')}/${Linea[
                  ...
                  <div
                    v-if="
                      Linea['VisitasServicios::EstadoServicio'] == 'PENDIENTE'
                    "
                    class="historicoBoton col"
                  >
                    <b-button variant="success" @click="finishVisita(Linea.recordId)"
                ...
                <div class="boton-carga-parent">
                  <button
                    v-if="limite < visita.VisitasServicios.length"
                    style="z-index: 9"
                    class="boton-carga"
                    @click="limite += 5"
                  >
                  ...
                  <span
                    class="ml-1"
                    v-if="limite >= visita.VisitasServicios.length"
                    >Límite {{ visita.VisitasServicios.length }} registros
                    alcanzado</span
                  >
              ...
              <div
                class="no-data"
                v-if="visita.VisitasServicios.length === 0 && !loading"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  data-name="Layer 1"
      ...
      <div
        v-if="pestañaActiva === 'Visita' && this.loading === false"
        class="añadir"
      >
        <b-icon
          @click="crearVisita()"

    ...
    <div>
            ...
            <div v-if="!this.loading && this.visitas" class="tareas-rows" :class="this.loading != true && this.visitas.length == 0
                    ...
                    <div class="mx-4 my-2">
                        <NuxtLink :to="`${visita.fieldData.NumeroServicio.replace('/', '')}`">
                            <div class="d-flex align-center mb-2" style="height:20px">
                                <small class="num-visita" style="line-height:1.2">{{ visita.fieldData.Numero }} </small>
                                <b-badge class="ml-2"
                ...
                <div class="boton-carga-parent">
                    <div class="boton-carga-parent d-flex">
                        ...
                        <span style="width:55%" v-if="limite >= this.visitas.length">Límite {{ this.visitas.length }}
                            registros
                            alcanzado</span>
        ...
        <div v-if="this.loading === false && (this.visitas.length == 0 || !this.visitas)" class="no-data">
            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="250" height="250"
                viewBox="0 0 485.83373 483.5" xmlns:xlink="http://www.w3.org/1999/xlink">
                <path

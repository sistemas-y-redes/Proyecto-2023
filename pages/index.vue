<template>
  <div>
    <div class="lista-tareas">
      <div
        v-if="!this.loading && this.visitas"
        class="tareas-rows"
        :class="
          this.loading != true && this.visitas.length == 0
            ? 'ocultar-tareas'
            : ''
        "
      >
        <div
          v-for="(visita, index) in this.visitas.slice(0, limite)"
          :key="index"
          class="tarea"
        >
          <div class="mx-4 my-2">
    ...
    <div
      v-if="this.loading === false && (this.visitas.length == 0 || !this.visitas)"
      class="no-data"
    >
      <svg

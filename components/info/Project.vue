    ...
    <div class="project-address">
      <b-row class="project-info-row">
        <b-col col xs="10" class="project-info-item">
          ...
          <span class="project-item-text">{{ project.fieldData.DirecciónObra }}</span>
        </b-col>
...
export default {
  ...
  data() {
    return {
      ...
      }+${this.project.fieldData.DirecciónObra.replace(
        /\s/g,
        "+"
  ...
  methods: {
    rellenarCamposDireccion() {
      ...
      this.direccionObra = this.project.fieldData.DirecciónObra.replace(
        /[0-9]/g,
        ""
      );
      this.direccionObra = this.direccionObra.replace(/,/g, "");
      this.direccionObra = this.direccionObra.replace(/\s/g, "%20");
      this.numDireccionObra = this.project.fieldData.DirecciónObra.replace(
        /[A-z]|\s|,/g,
        ""
      );
